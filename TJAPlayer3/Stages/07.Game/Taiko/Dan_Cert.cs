	...
	internal class Dan_Cert : CActivity
	{
		...
		public void DrawExam(Dan_C[] dan_C)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				#region ゲージの土台を描画する。
				if (TJAPlayer3.Tx.DanC_Base != null)
				{
					PanelY = (int)(TJAPlayer3.Skin.Game_DanC_Y - (TJAPlayer3.Skin.Game_DanC_Y_Padding * PanelOffset) + (TJAPlayer3.Skin.Game_DanC_Y_Padding * i) - (TJAPlayer3.Tx.DanC_Base.szテクスチャサイズ.Height / 2));
					TJAPlayer3.Tx.DanC_Base?.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1], PanelY);
				}
				#endregion
				...
				TJAPlayer3.Tx.DanC_Gauge[drawGaugeType]?.t2D描画(TJAPlayer3.app.Device,
					TJAPlayer3.Skin.Game_DanC_X[count - 1] + TJAPlayer3.Skin.Game_DanC_Offset[0], PanelY - TJAPlayer3.Skin.Game_DanC_Offset[1], new Rectangle(0, 0, (int)(dan_C[i].GetAmountToPercent() * (TJAPlayer3.Tx.DanC_Gauge[drawGaugeType].szテクスチャサイズ.Width / 100.0)), TJAPlayer3.Tx.DanC_Gauge[drawGaugeType].szテクスチャサイズ.Height));
				#endregion
				...
				if (TJAPlayer3.Tx.DanC_Number != null)
				{
					...
					switch (dan_C[i].Type)
					{
						case Exam.Type.Gauge:
							// パーセント
							TJAPlayer3.Tx.DanC_ExamUnit?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + TJAPlayer3.Skin.Game_DanC_Number_Small_Number_Offset[0] + TJAPlayer3.Skin.Game_DanC_Number_Small_Padding - TJAPlayer3.Skin.Game_DanC_Percent_Hit_Score_Padding[0], PanelY - TJAPlayer3.Skin.Game_DanC_Number_Small_Number_Offset[1] + TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1] * 0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[0], TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1]));
							break;
						case Exam.Type.Score:
							TJAPlayer3.Tx.DanC_ExamUnit?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + TJAPlayer3.Skin.Game_DanC_Number_Small_Number_Offset[0] + TJAPlayer3.Skin.Game_DanC_Number_Small_Padding - TJAPlayer3.Skin.Game_DanC_Percent_Hit_Score_Padding[2], PanelY - TJAPlayer3.Skin.Game_DanC_Number_Small_Number_Offset[1] + TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1] * 2, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[0], TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1]));

							// 点
							break;
						case Exam.Type.Roll:
						case Exam.Type.Hit:
							TJAPlayer3.Tx.DanC_ExamUnit?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + TJAPlayer3.Skin.Game_DanC_Number_Small_Number_Offset[0] + TJAPlayer3.Skin.Game_DanC_Number_Small_Padding - TJAPlayer3.Skin.Game_DanC_Percent_Hit_Score_Padding[1], PanelY - TJAPlayer3.Skin.Game_DanC_Number_Small_Number_Offset[1] + TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1] * 1, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[0], TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1]));

							// 打
							break;
						case Exam.Type.Combo:
							TJAPlayer3.Tx.DanC_ExamUnit?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + TJAPlayer3.Skin.Game_DanC_Number_Small_Number_Offset[0] + TJAPlayer3.Skin.Game_DanC_Number_Small_Padding - TJAPlayer3.Skin.Game_DanC_Percent_Hit_Score_Padding[3], PanelY - TJAPlayer3.Skin.Game_DanC_Number_Small_Number_Offset[1] + TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1] * 3, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[0], TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1]));
							//コンボ
							break;
						default:
							// 何もしない
				...
				if (TJAPlayer3.Tx.DanC_ExamRange != null)
					TJAPlayer3.Tx.DanC_ExamRange?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + offset - TJAPlayer3.Tx.DanC_ExamRange.szテクスチャサイズ.Width, PanelY - TJAPlayer3.Skin.Game_DanC_Exam_Offset[1] + (TJAPlayer3.Tx.DanC_ExamRange.szテクスチャサイズ.Height/2), new Rectangle(0, (TJAPlayer3.Tx.DanC_ExamRange.szテクスチャサイズ.Height / 2) * (int)dan_C[i].Range, TJAPlayer3.Tx.DanC_ExamRange.szテクスチャサイズ.Width, (TJAPlayer3.Tx.DanC_ExamRange.szテクスチャサイズ.Height / 2)));
				offset -= TJAPlayer3.Tx.DanC_ExamRange.szテクスチャサイズ.Width;
				...
				switch (dan_C[i].Type)
				{
					case Exam.Type.Gauge:
						// パーセント
						TJAPlayer3.Tx.DanC_ExamUnit?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + offset - TJAPlayer3.Skin.Game_DanC_Percent_Hit_Score_Padding[0], PanelY - TJAPlayer3.Skin.Game_DanC_Exam_Offset[1] + TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1] * 0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[0], TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1]));
						offset -= TJAPlayer3.Skin.Game_DanC_Percent_Hit_Score_Padding[0];
						break;
					case Exam.Type.Score:
						TJAPlayer3.Tx.DanC_ExamUnit?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + offset - TJAPlayer3.Skin.Game_DanC_Percent_Hit_Score_Padding[2], PanelY - TJAPlayer3.Skin.Game_DanC_Exam_Offset[1] + TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1] * 2, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[0], TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1]));
					...
					case Exam.Type.Roll:
					case Exam.Type.Hit:
						TJAPlayer3.Tx.DanC_ExamUnit?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + offset - TJAPlayer3.Skin.Game_DanC_Percent_Hit_Score_Padding[1], PanelY - TJAPlayer3.Skin.Game_DanC_Exam_Offset[1] + TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1] * 1, TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[0], TJAPlayer3.Skin.Game_DanC_ExamUnit_Size[1]));
				...
				// 条件の種類
				TJAPlayer3.Tx.DanC_ExamType?.t2D拡大率考慮下基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1] + offset - TJAPlayer3.Tx.DanC_ExamType.szテクスチャサイズ.Width, PanelY - TJAPlayer3.Skin.Game_DanC_Exam_Offset[1] + TJAPlayer3.Skin.Game_DanC_ExamType_Size[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_ExamType_Size[1] * (int)dan_C[i].Type, TJAPlayer3.Skin.Game_DanC_ExamType_Size[0], TJAPlayer3.Skin.Game_DanC_ExamType_Size[1]));
				#endregion

				#region 条件達成失敗の画像を描画する。
				if (dan_C[i].GetReached())
				{
					TJAPlayer3.Tx.DanC_Failed?.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_X[count - 1], PanelY);
				}
				#endregion
			}
		}
		...
		public void DrawExamV2(Dan_C[] dan_C,Dan_C DanCGauge)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				{
					PanelY = TJAPlayer3.Skin.Game_DanC_v2_Panel_Y[i];
					TJAPlayer3.Tx.DanC_V2_Panel.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i], PanelY);
				}
				#endregion
				...
				{
					TJAPlayer3.Tx.DanC_V2_Base.vc拡大縮小倍率.X = GaugeXRatio;
					TJAPlayer3.Tx.DanC_V2_Base.vc拡大縮小倍率.Y = 1.0f;
					TJAPlayer3.Tx.DanC_V2_Base?.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[1]);
				}
				#endregion
				...
				{
					TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].vc拡大縮小倍率.X = GaugeXRatio;
					TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].vc拡大縮小倍率.Y = 1.0f;
					TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[0] + (int)(TJAPlayer3.Skin.Game_DanC_v2_Gauge_Offset[0] * GaugeXRatio), PanelY + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[1] + TJAPlayer3.Skin.Game_DanC_v2_Gauge_Offset[1], new Rectangle(0, 0, (int)(dan_C[i].GetAmountToPercent() * (TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].szテクスチャサイズ.Width / 100.0)), TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].szテクスチャサイズ.Height));
				}
				#endregion
				...
				DrawNumberV2(nowAmount, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[0] + TJAPlayer3.Skin.Game_DanC_v2_Amount_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[1] + TJAPlayer3.Skin.Game_DanC_v2_Amount_Offset[1],
				...
				// 条件の範囲
				if (TJAPlayer3.Tx.DanC_V2_ExamRange != null)
					TJAPlayer3.Tx.DanC_V2_ExamRange?.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_ExamRange_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_ExamRange_Offset[1], new Rectangle(0, TJAPlayer3.Tx.DanC_V2_ExamRange.szテクスチャサイズ.Height / 2 * (int)dan_C[i].Range, TJAPlayer3.Tx.DanC_V2_ExamRange.szテクスチャサイズ.Width, TJAPlayer3.Tx.DanC_V2_ExamRange.szテクスチャサイズ.Height / 2));

				// 条件の数字
				DrawNumberV2(dan_C[i].GetValue(false), TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_ExamRange_Offset[0] + TJAPlayer3.Skin.Game_DanC_v2_ExamRangeNum_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_ExamRange_Offset[1] + TJAPlayer3.Skin.Game_DanC_v2_ExamRangeNum_Offset[1], true, TJAPlayer3.Skin.Game_DanC_v2_Number_Small_Scale, TJAPlayer3.Skin.Game_DanC_v2_Number_Small_Scale);
				// 条件の種類
				if (TJAPlayer3.Tx.DanC_V2_ExamType != null)
				{
					if (TJAPlayer3.Tx.DanC_V2_ExamType_Box != null)
					{
						...
						TJAPlayer3.Tx.DanC_V2_ExamType_Box?.t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_ExamType_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_ExamType_Offset[1]);
					}
					TJAPlayer3.Tx.DanC_V2_ExamType?.t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_ExamType_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_ExamType_Offset[1], new Rectangle(0, TJAPlayer3.Skin.Game_DanC_v2_ExamType_Size[1] * (int)dan_C[i].Type, TJAPlayer3.Skin.Game_DanC_v2_ExamType_Size[0], TJAPlayer3.Skin.Game_DanC_v2_ExamType_Size[1]));
				}
				#endregion
				...
				if (dan_C[i].GetReached())
				{
					if (TJAPlayer3.Tx.DanC_V2_Failed_Cover != null)
					{
						TJAPlayer3.Tx.DanC_V2_Failed_Cover.vc拡大縮小倍率.X = GaugeXRatio;
						TJAPlayer3.Tx.DanC_V2_Failed_Cover.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[1]);

						if (TJAPlayer3.Tx.DanC_V2_Failed_Text != null)
						{
							int textx = TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[0] + (int)(TJAPlayer3.Tx.DanC_V2_Failed_Cover.szテクスチャサイズ.Width * GaugeXRatio / 2) - (TJAPlayer3.Tx.DanC_V2_Failed_Text.szテクスチャサイズ.Width / 2);
							int texty = PanelY + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[1] + (int)(TJAPlayer3.Tx.DanC_V2_Failed_Cover.szテクスチャサイズ.Height / 2) - (TJAPlayer3.Tx.DanC_V2_Failed_Text.szテクスチャサイズ.Height / 2);
							TJAPlayer3.Tx.DanC_V2_Failed_Text.t2D描画(TJAPlayer3.app.Device, textx, texty);
						}
					}
				}
				#endregion
				...
				if (dan_C[i].IsForEachSongs)
				{
					...
					for (int examindex = 0; examindex < this.NowShowingNumber; examindex++)
					{
						...
						{
							TJAPlayer3.Tx.DanC_V2_Base.vc拡大縮小倍率.X = GaugeXRatio;
							TJAPlayer3.Tx.DanC_V2_Base.vc拡大縮小倍率.Y = GaugeYRatio;
							TJAPlayer3.Tx.DanC_V2_Base?.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset[0] + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[1] + TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset[1] + (examindex * TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset_Y_Padding));
						}
						//ゲージ
						drawGaugeType = 0;
						if (dan_C[i].Range == Exam.Range.More)
						...
						{
							TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].vc拡大縮小倍率.X = GaugeXRatio;
							TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].vc拡大縮小倍率.Y = GaugeYRatio;
							TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset[0] + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[0] + (int)(TJAPlayer3.Skin.Game_DanC_v2_Gauge_Offset[0] * GaugeXRatio), PanelY + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[1] + TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset[1] + (int)(TJAPlayer3.Skin.Game_DanC_v2_Gauge_Offset[1] * GaugeYRatio) + (examindex * TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset_Y_Padding), new Rectangle(0, 0, (int)(dan_C[i].GetAmountToPercent(examindex) * (TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].szテクスチャサイズ.Width / 100.0)), TJAPlayer3.Tx.DanC_V2_Gauge[drawGaugeType].szテクスチャサイズ.Height));
						}
						//値
						nowAmount = 0;
						if (dan_C[i].Range == Exam.Range.Less)
						...
						DrawNumberV2(nowAmount, TJAPlayer3.Skin.Game_DanC_v2_Panel_X[i] + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[0] + TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset[0] + TJAPlayer3.Skin.Game_DanC_v2_Amount_Offset[0], PanelY + TJAPlayer3.Skin.Game_DanC_v2_Base_Offset[1] + TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset[1] + TJAPlayer3.Skin.Game_DanC_v2_Amount_Offset[1] + (examindex * TJAPlayer3.Skin.Game_DanC_v2_SmallGauge_Offset_Y_Padding),
		...
		private static void DrawNumber(int value, int x, int y, int padding, float scaleX = 1.0f, float scaleY = 1.0f, float scaleJump = 0.0f)
		{
			for (int i = 0; i < value.ToString().Length; i++)
			{
				if(TJAPlayer3.Tx.DanC_Number != null)
				{
					...
					Rectangle rectangle = new Rectangle(TJAPlayer3.Tx.DanC_Number.szテクスチャサイズ.Width / 10 * number, 0, TJAPlayer3.Tx.DanC_Number.szテクスチャサイズ.Width / 10, TJAPlayer3.Tx.DanC_Number.szテクスチャサイズ.Height);
					TJAPlayer3.Tx.DanC_Number.vc拡大縮小倍率.X = scaleX;
					TJAPlayer3.Tx.DanC_Number.vc拡大縮小倍率.Y = scaleY + scaleJump;
					TJAPlayer3.Tx.DanC_Number.t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, x + (TJAPlayer3.Tx.DanC_V2_Number.szテクスチャサイズ.Width / 20) - ((i + 1) * padding), y + (TJAPlayer3.Tx.DanC_V2_Number.szテクスチャサイズ.Height * scaleY), rectangle);
				}
			}
		}
