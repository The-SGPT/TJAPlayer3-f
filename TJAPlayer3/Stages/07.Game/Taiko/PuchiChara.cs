...
namespace TJAPlayer3
{
	class PuchiChara : CActivity
	{
		...
		public int On進行描画(int x, int y, bool isGrowing, int nPlayer, int alpha = 255, bool isBalloon = false)
		{
			...
			TJAPlayer3.Tx.PuchiChara[nPlayer].vc拡大縮小倍率 = new System.Numerics.Vector3((isBalloon ? TJAPlayer3.Skin.Game_PuchiChara_Scale[1] : TJAPlayer3.Skin.Game_PuchiChara_Scale[0]));
