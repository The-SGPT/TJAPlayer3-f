...
ビルドとしては、.NET Framework 4.6と.NET Framework 4.8がありますが、.NET Framework 4.8を推奨しています。  
.NET Framework 4.6版のビルド側には必要ファイルがそろっていませんので、  
net46フォルダ内のファイルをnet48フォルダ内のファイルに上書きしてください。
